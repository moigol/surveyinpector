...
<div id="review" class="<?php echo esc_attr( $classes ); ?>">
	...
	<?php
	if ( ! empty( $review['total'] && ! $review['hide_desc'] ) && 'thumbs' != $review['user_review_type'] ) :
	...
	<?php if ( ( $review['pros'] || $review['cons'] ) && ! $review['hide_desc'] ) : ?>
...
<style type="text/css">
	...
	@media screen and (max-width:480px) {
		...
		.wp-review-<?php echo $review['post_id']; ?>.review-wrapper .review-total-wrapper span.review-total-box h5 { margin-top: 0; }
		.wp-review-<?php echo $review['post_id']; ?>.review-wrapper .review-total-wrapper span.review-total-box div { line-height: 1; }
	}
</style>
<?php
